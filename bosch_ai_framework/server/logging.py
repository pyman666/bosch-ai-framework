"""Gunicorn configuration — JSON logging + QueueHandler + lifecycle hooks.

Usage::

    gunicorn -c bosch_ai_framework/server/logging.py myapp.main:app

Copy and customize as needed (workers, port, timeout, etc.).
"""
...
class JsonFormatter(logging.Formatter):
    """JSON structured logging for ELK / Cloud Logging."""
